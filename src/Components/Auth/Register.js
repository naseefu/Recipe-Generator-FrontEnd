  ...
  return (
    <div className='registermain grid grid-cols-2 max-h-screen overflow-hidden'>
      ...
      <div className='video-register relative'>
        <video className='h-screen' style={{width:"100%",objectFit:'cover'}} src='https://videos.pexels.com/video-files/4058077/4058077-uhd_1440_2732_25fps.mp4' autoPlay loop muted playsInline/>
      ...
      <div className='registerfields mt-10 p-10 overflow-auto max-h-[calc(90vh)] overflow-auto'>
        <div>
          ...
          <h1 className='text-left flex items-center gap-2 text-1xl font-bold'>
            <span><PiCookingPot /></span> Zervings
          </h1>

        </div>

        <div style={{width:"fit-content"}}>
          <h1 className='text-left mt-10 text-3xl font-bold lg:text-4xl xl:text-5xl'>Welcome to Zervings</h1>
          <p className='text-left text-1xl text-gray-500 mt-3 lg:text-1xl xl:text-[calc(18px)]'>Create Your Zervings Account</p>
        </div>
